...
class HistoricalTrialEventService:
    ...
    def _build_feature_payload(self, analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            "trial_features": {
                ...
                "event_date_quality_issues": trial.get("event_date_quality_issues") or [],
            },
            "event_date_quality": {
                "precision": trial.get("event_date_precision"),
                "source": trial.get("event_date_source"),
                "source_rank": trial.get("event_date_source_rank"),
                "confidence": trial.get("event_date_confidence"),
            ...
            "mapping_features": {
                ...
                "review_status": sponsor_mapping.get("review_status"),
                "reviewed_mapping_status": sponsor_mapping.get("reviewed_mapping_status"),
                "override_applied": sponsor_mapping.get("mapping_source") == "sponsor_mapping_review",
            },
            "regulatory_features": {
    ...
    def build_event_record(
        ...
        return {
            ...
            "sponsor_mapping_review_status": sponsor_mapping.get("review_status"),
            "sponsor_mapping_reviewed_mapping_status": sponsor_mapping.get("reviewed_mapping_status"),
            "sponsor_mapping_override_applied": sponsor_mapping.get("mapping_source") == "sponsor_mapping_review",
            "approval_record_count": len(approval_records),

        ...
        return [
            {
                ...
                "mapped_ticker": row[8],
                "event_date_candidate": row[9],
                "event_date_source": row[10],
                "event_date_source_rank": row[11],
                "event_date_confidence": row[12],
                "event_date_quality_score": row[13],
                "event_date_quality_tier": row[14],
                "sponsor_mapping_review_status": row[15],
                "sponsor_mapping_override_applied": row[16],
                "event_date_review_status": row[17],
                "event_date_review_reason": row[18],
                "event_date_override_applied": row[19],
                "event_day_return": row[20],
                "post_window_return": row[21],
                "is_model_ready": row[22],
                "warning_count": row[23],

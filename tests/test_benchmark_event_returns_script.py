        ...
        with (
            patch.dict(
                os.environ,
                {
                    ...
                    "EVENT_RETURN_BENCHMARK_SPONSOR": "Pfizer",
                    "EVENT_RETURN_BENCHMARK_PHASE": "PHASE 3",
                    "EVENT_RETURN_BENCHMARK_EVENT_DATE_QUALITY_TIER": "high",
                    "EVENT_RETURN_BENCHMARK_SPONSOR_MAPPING_REVIEW_STATUS": "approved",
                    "EVENT_RETURN_BENCHMARK_EVENT_DATE_REVIEW_STATUS": "approved",
